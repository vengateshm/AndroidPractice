...
class StockListAdapter(private val stockList: ArrayList<StockModel>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: StockModel) = with(itemView) {
            ...
            if (item.changeValue.toString().contains("-")) {
                changePercent.background =
                    ResourcesCompat.getDrawable(resources, android.R.color.holo_red_dark, null)
            } else {
                changePercent.background =
                    ResourcesCompat.getDrawable(resources, android.R.color.holo_green_dark, null)
            }
        }
    }
}